          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>CIN:</td>
                  <td>${selectedRecord.cin || "N/A"}</td>
                  <td>Pipe Size:</td>
                  <td>${selectedRecord.connection_size || "N/A"}</td>
                </tr>
                <tr>
                  <td>Bill Month:</td>
                  <td>${selectedRecord.billMonth || "N/A"}</td>
                  <td>Consumer Category:</td>
                  <td>${selectedRecord.category || "N/A"}</td>
                </tr>
                <tr>
            ...
            <table className="min-w-full border-collapse">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">{selectedRecord?.meter_stts.toUpperCase()}</td>
                  <td className="border px-4 py-2">Total Consumption:</td>
                  <td className="border px-4 py-2">20880</td>
                </tr>
                <tr>
                  <td className="border px-4 py-2">
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">
                    <strong>{selectedRecord?.basicCharge}</strong>
                  </td>
                </tr>
                <tr>
                  <td className="border px-4 py-2">Minimum Charge:</td>
                  <td className="border px-4 py-2">
                  {selectedRecord?.minimum}
                  </td>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">51.04</td>
                </tr>
                <tr>
                  ...
                  <td className="border px-4 py-2">N/A</td>
                  <td className="border px-4 py-2">N/A</td>
                  <td className="border px-4 py-2">33.18</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">
                    <strong>{selectedRecord?.rebate}</strong>
                  </td>
                </tr>
                <tr>
                  <td className="border px-4 py-2">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border px-4 py-2">
                      ...
                      : selectedRecord?.sewerage_tax == 'y' ? 'Y'
