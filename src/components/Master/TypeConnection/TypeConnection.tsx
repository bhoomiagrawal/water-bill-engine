...
const TypeConnection: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formValues.connectionType) newErrors.connectionType = "Connection Type Slab is required";
          ...
          <form onSubmit={handleSubmit} className="space-y-4 p-6">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="flex flex-col">
                <label htmlFor="connectionType" className="mb-1 font-medium">connection Type :</label>
                <input
                  type="text"
                  name="connectionType" 
                ...
                />
                {errors.connectionType && <div className="mt-1 text-red-600">{errors.connectionType}</div>}
              </div>
            </div>
