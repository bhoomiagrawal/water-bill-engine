...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      // },
      {
        ...
        route: "#",
        children: [
          { label: "Bill Agency Enrollment", route: "/billAgencyEnrollment" },
          { label: "Bill Agency Employees", route: "/billAgencyEmployees" },
          { label: "Employees Role Master", route: "/billAgencyEmployeesRole" },
        ],
      },
      {
        icon: (
      ...
      },
      {
        ...
        label: "Binder Configuration",
        route: "#",
        children: [
          { label: "Binder Mapping", route: "/binderMapping" },
          { label: "Meter Reader Binder", route: "/billAgencyEmployees" },
          { label: "Binder Schedule", route: "/billAgencyEmployees" },
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Bulk Bill ", route: "/bulk-bill" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Reading Sheet ", route: "/readingSheetForm" },
          // { label: "Bill Agency Employees", route: "/forms/billAgencyEmployees" },
        ],
      },
      // {
      //   icon: (
      ...
      //   route: "#",
      //   children: [
      //     { label: "Circle Master ", route: "/circleMaster" },
      //     // { label: "Bill Agency Employees", route: "/forms/billAgencyEmployees" },
      //   ],
      // },
        ...
        <div className="flex items-center  justify-between  px-6 py-5.5 lg:py-6.5">
          <Link href="/">
            <Image 
              width={50}
              height={50}
              src={"/images/logo/imageedit_3_5377320490.gif"}
              alt="Logo"
              priority
            /> 
          </Link>
          <h2 className="  text-2xl text-white">Rajneer</h2>
