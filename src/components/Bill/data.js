(exports.slabs = [
  ...
  (exports.minimumCharges = [
    ...
    { meter_size: 20, min_charges: 220, category: "d" },
    { meter_size: 25, min_charges: 550, category: "d" },
    { meter_size: 40, min_charges: 1650, category: "d" },
    { meter_size: 50, min_charges: 2750, category: "d" },
    { meter_size: 80, min_charges: 6600, category: "d" },
    { meter_size: 100, min_charges: 10450, category: "d" },
    { meter_size: 150, min_charges: 23650, category: "d" },

    { meter_size: 15, min_charges: 220, category: "nd" },
    { meter_size: 20, min_charges: 550, category: "nd" },
    { meter_size: 25, min_charges: 880, category: "nd" },
    { meter_size: 40, min_charges: 2640, category: "nd" },
    { meter_size: 50, min_charges: 4400, category: "nd" },
    { meter_size: 80, min_charges: 11000, category: "nd" },
    { meter_size: 100, min_charges: 17050, category: "nd" },
    { meter_size: 150, min_charges: 37950, category: "nd" },

    { meter_size: 15, min_charges: 550, category: "id" },
    { meter_size: 20, min_charges: 990, category: "id" },
    { meter_size: 25, min_charges: 1540, category: "id" },
    { meter_size: 40, min_charges: 4950, category: "id" },
    { meter_size: 50, min_charges: 7700, category: "id" },
...
exports.fixedCharges = [
  { meter_size: 15, fixed_charges: 27.5, category: "d" },
  { meter_size: 20, fixed_charges: 27.5, category: "d" },
  { meter_size: 25, fixed_charges: 27.5, category: "d" },
  { meter_size: 40, fixed_charges: 55, category: "d" },
  { meter_size: 50, fixed_charges: 82.5, category: "d" },
  { meter_size: 80, fixed_charges: 110, category: "d" },
  { meter_size: 100, fixed_charges: 165, category: "d" },
  { meter_size: 150, fixed_charges: 220, category: "d" },

  { meter_size: 15, fixed_charges: 55, category: "nd" },
  { meter_size: 20, fixed_charges: 55, category: "nd" },
  { meter_size: 25, fixed_charges: 55, category: "nd" },
  { meter_size: 40, fixed_charges: 110, category: "nd" },
  { meter_size: 50, fixed_charges: 165, category: "nd" },
  { meter_size: 80, fixed_charges: 220, category: "nd" },
  { meter_size: 100, fixed_charges: 330, category: "nd" },
  { meter_size: 150, fixed_charges: 440, category: "nd" },

  { meter_size: 15, fixed_charges: 110, category: "id" },
  { meter_size: 20, fixed_charges: 110, category: "id" },
  { meter_size: 25, fixed_charges: 110, category: "id" },
  { meter_size: 40, fixed_charges: 220, category: "id" },
  { meter_size: 50, fixed_charges: 330, category: "id" },
...
exports.meterServiceCharges = [
  { meter_size: 15, meter_service: 22 },
  { meter_size: 20, meter_service: 55 },
  { meter_size: 25, meter_service: 110 },
  { meter_size: 40, meter_service: 220 },
  { meter_size: 50, meter_service: 440 },
  { meter_size: 80, meter_service: 550 },
  { meter_size: 100, meter_service: 660 },
  { meter_size: 150, meter_service: 770 },
];
