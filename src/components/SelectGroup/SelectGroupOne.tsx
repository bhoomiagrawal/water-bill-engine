...
interface SelectGroupOneProps {
  ...
  className?: string; // This line allows passing a className
}

const SelectGroupOne: React.FC<SelectGroupOneProps> = ({ label, options, onChange, className }) => {
  ...
  return (
    <div className={`mb-4.5 ${className}`}> {/* Add className here */}
      ...
      <div className="relative z-20 bg-transparent dark:bg-form-input">
        ...
        <span className="absolute right-0 top-1/2 z-30 -translate-y-1/2">
          <svg
